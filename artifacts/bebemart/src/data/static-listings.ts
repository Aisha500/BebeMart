...
export const staticListings: Listing[] = [
  {
    ...
    ageGroup: "0-6m",
    condition: "Like New",
    images: ["/images/listing-romper.png"],
    sellerId: 1,
  ...
  },
  {
    ...
    ageGroup: "1-3y",
    condition: "Good",
    images: ["/images/listing-shoes.png"],
    sellerId: 2,
  ...
  },
  {
    ...
    ageGroup: "1-3y",
    condition: "Good",
    images: ["/images/listing-books.png"],
    sellerId: 2,
    sellerName: "Chioma Adeyemi",
    sellerRating: 4.5,
    state: "Abuja",
  ...
  },
  {
    ...
    ageGroup: "4-6y",
    condition: "Like New",
    images: ["/images/listing-train.png"],
    sellerId: 4,
  ...
  },
  {
    ...
    ageGroup: "6-12m",
    condition: "Like New",
    images: ["/images/listing-dresses.png"],
    sellerId: 1,
    sellerName: "Amara Okonkwo",
    sellerRating: 4.8,
    state: "Lagos",
  ...
  },
  {
    ...
    ageGroup: "1-3y",
    condition: "Good",
    images: ["/images/listing-lego.png"],
    sellerId: 4,
    sellerName: "Ngozi Eze",
    sellerRating: 4.2,
    state: "Port Harcourt",
  ...
  },
  {
    ...
    ageGroup: "0-6m",
    condition: "Good",
    images: ["/images/listing-stroller.png"],
    sellerId: 2,
    sellerName: "Chioma Adeyemi",
    sellerRating: 4.5,
    state: "Abuja",
  ...
  },
  {
    ...
    ageGroup: "7y+",
    condition: "Good",
    images: ["/images/listing-uniforms.png"],
    sellerId: 4,
    sellerName: "Ngozi Eze",
    sellerRating: 4.2,
    state: "Port Harcourt",
  ...
  },
  {
    ...
    ageGroup: "1-3y",
    condition: "Like New",
    images: ["/images/listing-puzzles.png"],
    sellerId: 2,
    sellerName: "Chioma Adeyemi",
    sellerRating: 4.5,
    state: "Abuja",
